        ...
        <script type="text/javascript">
            $(document).ready(function(){
                ...
                $(document).on("click",".search-box .input-group .input-group-append .btn",function () {
                    ...
                    $.get("controllers/backend-search.php?func=add_ingredient_to_shoppinglist", {term: inputVal,iduser: php_var}).done(function(data){
...
<div id="myModal" class="modal fade" role="dialog">
    <div class="modal-dialog">
        ...
        <div class="modal-content">
            ...
            <form action="index?action=shopping_list" method="post" enctype="multipart/form-data">
...
<form action="index?action=shopping_list"  method="post">
    ...
    <button type="submit" class="btn btn-primary" name="save_ingredients">Save Shoppinglist</button>
</form>
