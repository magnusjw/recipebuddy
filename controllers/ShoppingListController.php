...
if(isset($_POST)) {
    ...
    if(isset($_POST["add_ingredient"])){
        ...
        if ($uploadOk == 0) {
            ...
            if (move_uploaded_file($_FILES["fileToUpload"]["tmp_name"], $target_file)) {
                ...
                Database_Gateway::getInstance()->addIngredientToUserShoppingList($user_id,$last_id,1);
            } else {
    ...
    if(isset($_POST["save_ingredients"])){
        Database_Gateway::getInstance()->updateShoppinglist($user_id,$_POST["ingredientId"],$_POST["quantity"]);
    }
}

$array_ingredient = [];
$db_ingredients = Database_Gateway::getInstance()->getShoppinglist($user_id);
...
require_once ('views/html/shopping_list.php');